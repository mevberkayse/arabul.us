    ...
    <div class="mb-3 w-100">
        ...
        <div class="input-group">
            <input 
                ...
                readonly 
                data-bs-toggle="modal" 
                data-bs-target="#garantiModal"
                style="background-color: #f8f9fa; border: 1px solid #ced4da; cursor: pointer; border-right: none;"> <!-- Sağ kenarlık kaldırıldı -->
            <span 
                class="input-group-text" 
                data-bs-toggle="modal" 
                data-bs-target="#garantiModal" 
                style="background-color: #f8f9fa; border: 1px solid #ced4da; border-left: none; cursor: pointer;"> <!-- Sol kenarlık kaldırıldı -->
                <i class="fa fa-chevron-right" aria-hidden="true" style="color: #000;"></i> <!-- Ok rengi siyah yapıldı -->
            </span>
        </div>
    </div>
    <!-- Renk Başlığı -->
