...
<style>
   ...
   @import url('https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap');
    ...
    ul.list-unstyled li:first-child a {
        font-weight: bold; /* Yazıyı koyu yapmak için */
        color: #000; /* Rengi siyah yapmak için */
    }
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-3">
                <ul class="list-unstyled">
                    ...
                    <li class="mb-3"><a href="#" class="text-dark text-decoration-none">Tüm cihazlardan çıkış yap</a></li>
    ...
    <i class="fa-regular fa-eye-slash position-absolute top-50 end-0 translate-middle-y pe-3 toggle-password" data-input="current-password" style="cursor: pointer;"></i>
</div>
        <!-- Yeni şifre girişi -->
        <div class="position-relative mb-3">
            <input type="password" class="form-control" placeholder="Yeni şifrenizi girin" id="new-password" name="new-password">
            <i class="fa-regular fa-eye-slash position-absolute top-50 end-0 translate-middle-y pe-3 toggle-password" data-input="new-password" style="cursor: pointer;"></i>
        </div>
        ...
        <div class="position-relative mb-3">
            ...
            <i class="fa-regular fa-eye-slash position-absolute top-50 end-0 translate-middle-y pe-3 toggle-password" data-input="confirm-password" style="cursor: pointer;"></i>
        </div>
    </div>
    <!-- Kaydet Butonu -->
  ...
  document.querySelectorAll('.toggle-password').forEach(function(icon) {
    icon.addEventListener('click', function() {
        ...
        if (inputField.type === 'password') {
            inputField.type = 'text';  // Şifreyi görünür yap
            this.classList.remove('fa-eye-slash');  // Göz ikonunu değiştir
            this.classList.add('fa-eye');
        } else {
            inputField.type = 'password';  // Şifreyi gizle
            this.classList.remove('fa-eye');  // Göz ikonunu değiştir
